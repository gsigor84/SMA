...
lista=['keto.gabydefarias','keto_nat_uk','sweetlowcarb','prepare.meals','prepare.meals','keto_diet.recipes94','keentoketolean','ketohelper11','gemellihome','ketoohelper','ketohelpercare','ketoorigin','keto.yummy.taste']
index=[]
n=0
while n < len(lista):
    index.append(n)
...
#Post the Image
    ...
    'caption': 'follow @cubanfit_91'+HashTagKeto.hashtag,
    'access_token': token
    }
